OCCUPATIONS = (
    ...
    ('administration clerk', 'Administration Clerk'),
    ...
    ('advertising clerk', 'Advertising Clerk'),
    ('advertising contractor', 'Advertising Contractor'),
    ('advertising executive', 'Advertising Executive'),
    ('advertising manager', 'Advertising Manager'),
    ('advertising staff', 'Advertising Staff'),
    ('aerial erector', 'Aerial Erector'),
    ('aerobic instructor', 'Aerobic Instructor'),
    ...
    ('aircraft surface finisher', 'Aircraft Surface Finisher'),
    ('airman', 'Airman'),
    ('airport controller', 'Airport Controller'),
    ('airport manager', 'Airport Manager'),
    ('almoner', 'Almoner'),
    ('ambulance controller', 'Ambulance Controller'),
    ('ambulance crew', 'Ambulance Crew'),
    ('ambulance driver', 'Ambulance Driver'),
    ('amusement arcade worker', 'Amusement Arcade Worker'),
    ...
    ('bacon curer', 'Bacon Curer'),
    ('baggage handler', 'Baggage Handler'),
    ('bailiff', 'Bailiff'),
    ('baker', 'Baker'),
    ('bakery assistant', 'Bakery Assistant'),
    ('bakery manager', 'Bakery Manager'),
    ('bakery operator', 'Bakery Operator'),
    ('balloonist', 'Balloonist'),
    ('bank clerk', 'Bank Clerk'),
    ('bank manager', 'Bank Manager'),
    ('bank messenger', 'Bank Messenger'),
    ...
    ('blind assembler', 'Blind Assembler'),
    ('blind fitter', 'Blind Fitter'),
    ('blinds installer', 'Blinds Installer'),
    ('boat builder', 'Boat Builder'),
    ('body fitter', 'Body Fitter'),
    ('bodyguard', 'Bodyguard'),
    ('bodyshop', 'Bodyshop'),
    ...
    ('breeder', 'Breeder'),
    ('brewer', 'Brewer'),
    ('brewery manager', 'Brewery Manager'),
    ('brewery worker', 'Brewery Worker'),
    ('bricklayer', 'Bricklayer'),
    ('broadcaster', 'Broadcaster'),
    ('builder', 'Builder'),
    ('builders labourer', 'Builders Labourer'),
    ('building advisor', 'Building Advisor'),
    ('building control', 'Building Control'),
    ('building engineer', 'Building Engineer'),
    ('building estimator', 'Building Estimator'),
    ('building foreman', 'Building Foreman'),
    ...
    ('careers officer', 'Careers Officer'),
    ('caretaker', 'Caretaker'),
    ('cargo operator', 'Cargo Operator'),
    ('carpenter', 'Carpenter'),
    ('carpet cleaner', 'Carpet Cleaner'),
    ('carpet fitter', 'Carpet Fitter'),
    ('carpet retailer', 'Carpet Retailer'),
    ('carphone fitter', 'Carphone Fitter'),
    ('cartographer', 'Cartographer'),
    ('cartoonist', 'Cartoonist'),
    ('cashier', 'Cashier'),
    ('casual worker', 'Casual Worker'),
    ('caterer', 'Caterer'),
    ('catering consultant', 'Catering Consultant'),
    ...
    ('child minder', 'Child Minder'),
    ('childminder', 'Childminder'),
    ('chimney sweep', 'Chimney Sweep'),
    ('china restorer', 'China Restorer'),
    ...
    ('circus proprietor', 'Circus Proprietor'),
    ('circus worker', 'Circus Worker'),
    ...
    ('florist', 'Florist'),
    ('flour miller', 'Flour Miller'),
    ('flower arranger', 'Flower Arranger'),
    ('flying instructor', 'Flying Instructor'),
    ('foam convertor', 'Foam Convertor'),
    ...
    ('forester', 'Forester'),
    ('fork lift truck driver', 'Fork Lift Truck Driver'),
    ...
    ('funeral furnisher', 'Funeral Furnisher'),
    ('furnace man', 'Furnace Man'),
    ('furniture dealer', 'Furniture Dealer'),
    ('furniture remover', 'Furniture Remover'),
    ('furniture restorer', 'Furniture Restorer'),
    ('furrier', 'Furrier'),
    ('gallery owner', 'Gallery Owner'),
    ('gambler', 'Gambler'),
    ('gamekeeper', 'Gamekeeper'),
    ('gaming board inspector', 'Gaming Board Inspector'),
    ('gaming club manager', 'Gaming Club Manager'),
    ('gaming club proprietor', 'Gaming Club Proprietor'),
    ('garage attendant', 'Garage Attendant'),
    ('garage foreman', 'Garage Foreman'),
    ('garage manager', 'Garage Manager'),
    ('garda', 'Garda'),
    ('garden designer', 'Garden Designer'),
    ('gardener', 'Gardener'),
    ('gas fitter', 'Gas Fitter'),
    ('gas mechanic', 'Gas Mechanic'),
    ...
    ('golf club professional', 'Golf Club Professional'),
    ('golfer', 'Golfer'),
    ('goods handler', 'Goods Handler'),
    ('governor', 'Governor'),
    ('granite technician', 'Granite Technician'),
    ('graphic designer', 'Graphic Designer'),
    ('graphologist', 'Graphologist'),
    ('grave digger', 'Grave Digger'),
    ('gravel merchant', 'Gravel Merchant'),
    ('green keeper', 'Green Keeper'),
    ('greengrocer', 'Greengrocer'),
    ('grocer', 'Grocer'),
    ('groom', 'Groom'),
    ('ground worker', 'Ground Worker'),
    ('groundsman', 'Groundsman'),
    ('guest house owner', 'Guest House Owner'),
    ('guest house proprietor', 'Guest House Proprietor'),
    ('gun smith', 'Gun Smith'),
    ('gynaecologist', 'Gynaecologist'),
    ('hgv driver', 'HGV Driver'),
    ('hgv mechanic', 'HGV Mechanic'),
    ('hairdresser', 'Hairdresser'),
    ('handyman', 'Handyman'),
    ('hardware dealer', 'Hardware Dealer'),
    ...
    ('health therapist', 'Health Therapist'),
    ('health visitor', 'Health Visitor'),
    ('hearing therapist', 'Hearing Therapist'),
    ('heating engineer', 'Heating Engineer'),
    ('herbalist', 'Herbalist'),
    ('highway inspector', 'Highway Inspector'),
    ('hire car driver', 'Hire Car Driver'),
    ('historian', 'Historian'),
    ('history teacher', 'History Teacher'),
    ('hod carrier', 'Hod Carrier'),
    ('home economist', 'Home Economist'),
    ('home help', 'Home Help'),
    ('homecare manager', 'Homecare Manager'),
    ('homeopath', 'Homeopath'),
    ('homeworker', 'Homeworker'),
    ('hop merchant', 'Hop Merchant'),
    ...
    ('hosiery mechanic', 'Hosiery Mechanic'),
    ('hosiery worker', 'Hosiery Worker'),
    ('hospital consultant', 'Hospital Consultant'),
    ('hospital doctor', 'Hospital Doctor'),
    ('hospital manager', 'Hospital Manager'),
    ('hospital orderly', 'Hospital Orderly'),
    ('hospital technician', 'Hospital Technician'),
    ('hospital warden', 'Hospital Warden'),
    ('hospital worker', 'Hospital Worker'),
    ('hostess', 'Hostess'),
    ('hot foil printer', 'Hot Foil Printer'),
    ('hotel consultant', 'Hotel Consultant'),
    ('hotel worker', 'Hotel Worker'),
    ('hotelier', 'Hotelier'),
    ('househusband', 'Househusband'),
    ('housekeeper', 'Housekeeper'),
    ('housewife', 'Housewife'),
    ('housing assistant', 'Housing Assistant'),
    ('housing officer', 'Housing Officer'),
    ('housing supervisor', 'Housing Supervisor'),
    ('hygienist', 'Hygienist'),
    ...
    ('import consultant', 'Import Consultant'),
    ('importer', 'Importer'),
    ('independent means', 'Independent Means'),
    ('induction moulder', 'Induction Moulder'),
    ('industrial chemist', 'Industrial Chemist'),
    ('industrial consultant', 'Industrial Consultant'),
    ('injection moulder', 'Injection Moulder'),
    ('inspector', 'Inspector'),
    ...
    ('insurance assessor', 'Insurance Assessor'),
    ('insurance broker', 'Insurance Broker'),
    ('insurance consultant', 'Insurance Consultant'),
    ('insurance inspector', 'Insurance Inspector'),
    ...
    ('jockey', 'Jockey'),
    ('joiner', 'Joiner'),
    ('joinery consultant', 'Joinery Consultant'),
    ('journalist', 'Journalist'),
    ('judge', 'Judge'),
    ('keep fit instructor', 'Keep Fit Instructor'),
    ('kennel hand', 'Kennel Hand'),
    ('kitchen worker', 'Kitchen Worker'),
    ('knitter', 'Knitter'),
    ('labelling operator', 'Labelling Operator'),
    ('laboratory analyst', 'Laboratory Analyst'),
    ('labourer', 'Labourer'),
    ('laminator', 'Laminator'),
    ('lampshade maker', 'Lampshade Maker'),
    ...
    ('lawyer', 'Lawyer'),
    ('leaflet distributor', 'Leaflet Distributor'),
    ...
    ('lime kiln attendant', 'Lime Kiln Attendant'),
    ...
    ('litigation manager', 'Litigation Manager'),
    ('loans manager', 'Loans Manager'),
    ('local government', 'Local Government'),
    ('lock keeper', 'Lock Keeper'),
    ('locksmith', 'Locksmith'),
    ('locum pharmacist', 'Locum Pharmacist'),
    ('log merchant', 'Log Merchant'),
    ('lorry driver', 'Lorry Driver'),
    ('loss adjustor', 'Loss Adjustor'),
    ('loss assessor', 'Loss Assessor'),
    ('lumberjack', 'Lumberjack'),
    ('machine fitters', 'Machine Fitters'),
    ('machine minder', 'Machine Minder'),
    ('machine operator', 'Machine Operator'),
    ('machine setter', 'Machine Setter'),
    ('machine tool', 'Machine Tool'),
    ('machine tool fitter', 'Machine Tool Fitter'),
    ('machinist', 'Machinist'),
    ('magician', 'Magician'),
    ('magistrate', 'Magistrate'),
    ('magistrates clerk', 'Magistrates Clerk'),
    ('maid', 'Maid'),
    ('maintenance fitter', 'Maintenance Fitter'),
    ('make up artist', 'Make Up Artist'),
    ('manicurist', 'Manicurist'),
    ('manufacturing', 'Manufacturing'),
    ('map mounter', 'Map Mounter'),
    ('marble finisher', 'Marble Finisher'),
    ('marble mason', 'Marble Mason'),
    ('marine broker', 'Marine Broker'),
    ('marine consultant', 'Marine Consultant'),
    ('marine electrician', 'Marine Electrician'),
    ...
    ('marquee erector', 'Marquee Erector'),
    ...
    ('medical supplier', 'Medical Supplier'),
    ...
    ('messenger', 'Messenger'),
    ('metal dealer', 'Metal Dealer'),
    ('metal engineer', 'Metal Engineer'),
    ('metal polisher', 'Metal Polisher'),
    ...
    ('milklady', 'Milklady'),
    ('milkman', 'Milkman'),
    ('mill operator', 'Mill Operator'),
    ('mill worker', 'Mill Worker'),
    ('miller', 'Miller'),
    ('milliner', 'Milliner'),
    ('millwright', 'Millwright'),
    ('miner', 'Miner'),
    ('mineralologist', 'Mineralologist'),
    ('minibus driver', 'Minibus Driver'),
    ('minicab driver', 'Minicab Driver'),
    ('mining consultant', 'Mining Consultant'),
    ('mining engineer', 'Mining Engineer'),
    ('money broker', 'Money Broker'),
    ('moneylender', 'Moneylender'),
    ('mooring contractor', 'Mooring Contractor'),
    ('mortgage broker', 'Mortgage Broker'),
    ('mortician', 'Mortician'),
    ('motor dealer', 'Motor Dealer'),
    ('motor engineer', 'Motor Engineer'),
    ('motor fitter', 'Motor Fitter'),
    ('motor mechanic', 'Motor Mechanic'),
    ('motor racing', 'Motor Racing'),
    ('motor trader', 'Motor Trader'),
    ('museum assistant', 'Museum Assistant'),
    ...
    ('oil broker', 'Oil Broker'),
    ('oil rig crew', 'Oil Rig Crew'),
    ('opera singer', 'Opera Singer'),
    ('operations', 'Operations'),
    ('operative', 'Operative'),
    ('operator', 'Operator'),
    ('optical', 'Optical'),
    ('optical advisor', 'Optical Advisor'),
    ...
    ('patrolman', 'Patrolman'),
    ('pattern cutter', 'Pattern Cutter'),
    ('pattern maker', 'Pattern Maker'),
    ('pattern weaver', 'Pattern Weaver'),
    ('pawnbroker', 'Pawnbroker'),
    ('payroll assistant', 'Payroll Assistant'),
    ...
    ('picture framer', 'Picture Framer'),
    ('picture reseacher', 'Picture Reseacher'),
    ('pig man', 'Pig Man'),
    ('pig manager', 'Pig Manager'),
    ('pilot', 'Pilot'),
    ('pipe fitter', 'Pipe Fitter'),
    ('pipe inspector', 'Pipe Inspector'),
    ('pipe insulator', 'Pipe Insulator'),
    ...
    ('plant attendant', 'Plant Attendant'),
    ('plant driver', 'Plant Driver'),
    ('plant engineer', 'Plant Engineer'),
    ('plant fitter', 'Plant Fitter'),
    ('plant manager', 'Plant Manager'),
    ('plant operator', 'Plant Operator'),
    ('plasterer', 'Plasterer'),
    ('plastics consultant', 'Plastics Consultant'),
    ('plastics engineer', 'Plastics Engineer'),
    ('plate layer', 'Plate Layer'),
    ('plater', 'Plater'),
    ('playgroup assistant', 'Playgroup Assistant'),
    ('playgroup leader', 'Playgroup Leader'),
    ('plumber', 'Plumber'),
    ('podiatrist', 'Podiatrist'),
    ('police officer', 'Police Officer'),
    ('polisher', 'Polisher'),
    ('pool attendant', 'Pool Attendant'),
    ('pools collector', 'Pools Collector'),
    ('porter', 'Porter'),
    ('portfolio manager', 'Portfolio Manager'),
    ('post sorter', 'Post Sorter'),
    ('postman', 'Postman'),
    ...
    ('press setter', 'Press Setter'),
    ('presser', 'Presser'),
    ('priest', 'Priest'),
    ('print finisher', 'Print Finisher'),
    ('printer', 'Printer'),
    ('prison chaplain', 'Prison Chaplain'),
    ('prison officer', 'Prison Officer'),
    ('private investigator', 'Private Investigator'),
    ('probation officer', 'Probation Officer'),
    ('probation worker', 'Probation Worker'),
    ('procurator fiscal', 'Procurator Fiscal'),
    ('produce supervisor', 'Produce Supervisor'),
    ('producer', 'Producer'),
    ('product installer', 'Product Installer'),
    ('product manager', 'Product Manager'),
    ('production engineer', 'Production Engineer'),
    ('production hand', 'Production Hand'),
    ('production manager', 'Production Manager'),
    ('production planner', 'Production Planner'),
    ('professional boxer', 'Professional Boxer'),
    ('professional racing', 'Professional Racing'),
    ('professional wrestler', 'Professional Wrestler'),
    ('progress chaser', 'Progress Chaser'),
    ('progress clerk', 'Progress Clerk'),
    ...
    ('public relations of?cer', 'Public Relations Of?cer'),
    ('publican', 'Publican'),
    ('publicity manager', 'Publicity Manager'),
    ('publisher', 'Publisher'),
    ('publishing manager', 'Publishing Manager'),
    ('purchase clerk', 'Purchase Clerk'),
    ...
    ('racehorse groom', 'Racehorse Groom'),
    ('racing organiser', 'Racing Organiser'),
    ...
    ('share dealer', 'Share Dealer'),
    ('sheet metal worker', 'Sheet Metal Worker'),
    ('shelf filler', 'Shelf Filler'),
    ('shelter warden', 'Shelter Warden'),
    ('shepherd', 'Shepherd'),
    ('sheriff', 'Sheriff'),
    ('sheriff clerk', 'Sheriff Clerk'),
    ...
    ('store detective', 'Store Detective'),
    ('storeman', 'Storeman'),
    ('storewoman', 'Storewoman'),
    ('street entertainer', 'Street Entertainer'),
    ('street trader', 'Street Trader'),
    ('stud hand', 'Stud Hand'),
    ('student', 'Student'),
    ...
    ('sub-postmistress', 'Sub-Postmistress'),
    ...
    ('tv editor', 'TV Editor'),
    ('tachograph analyst', 'Tachograph Analyst'),
    ('tacker', 'Tacker'),
    ('tailor', 'Tailor'),
    ('tank farm operative', 'Tank Farm Operative'),
    ...
    ('taxi controller', 'Taxi Controller'),
    ('taxi driver', 'Taxi Driver'),
    ('taxidermist', 'Taxidermist'),
    ('tea blender', 'Tea Blender'),
    ('tea taster', 'Tea Taster'),
    ('teacher', 'Teacher'),
    ('teachers assistant', 'Teachers Assistant'),
    ...
    ('telemarketeer', 'Telemarketeer'),
    ('telephone engineer', 'Telephone Engineer'),
    ('telephonist', 'Telephonist'),
    ('telesales person', 'Telesales Person'),
    ...
    ('textile consultant', 'Textile Consultant'),
    ('textile engineer', 'Textile Engineer'),
    ('textile technician', 'Textile Technician'),
    ('textile worker', 'Textile Worker'),
    ('thatcher', 'Thatcher'),
    ('theatre manager', 'Theatre Manager'),
    ('theatre technician', 'Theatre Technician'),
    ('theatrical agent', 'Theatrical Agent'),
    ('therapist', 'Therapist'),
    ...
    ('tiler', 'Tiler'),
    ('timber inspector', 'Timber Inspector'),
    ('timber worker', 'Timber Worker'),
    ...
    ('training co-ordinator', 'Training Co-ordinator'),
    ...
    ('transport clerk', 'Transport Clerk'),
    ('transport consultant', 'Transport Consultant'),
    ...
    ('travel guide writer', 'Travel Guide Writer'),
    ('travel representative', 'Travel Representative'),
    ('travelling showman', 'Travelling Showman'),
    ('treasurer', 'Treasurer'),
    ('tree feller', 'Tree Feller'),
    ('tree surgeon', 'Tree Surgeon'),
    ('trichologist', 'Trichologist'),
    ('trinity house pilot', 'Trinity House Pilot'),
    ('trout farmer', 'Trout Farmer'),
    ('tug skipper', 'Tug Skipper'),
    ('tunneller', 'Tunneller'),
    ('turf accountant', 'Turf Accountant'),
    ('turkey farmer', 'Turkey Farmer'),
    ('turner', 'Turner'),
    ('tutor', 'Tutor'),
    ('typesetter', 'Typesetter'),
    ('typewriter engineer', 'Typewriter Engineer'),
    ('typist', 'Typist'),
    ('tyre builder', 'Tyre Builder'),
    ('tyre fitter', 'Tyre Fitter'),
    ('tyre inspector', 'Tyre Inspector'),
    ...
    ('vehicle assessor', 'Vehicle Assessor'),
    ('vehicle body worker', 'Vehicle Body Worker'),
    ('vehicle engineer', 'Vehicle Engineer'),
    ...
    ('violinist', 'Violinist'),
    ('voluntary worker', 'Voluntary Worker'),
    ...
    ('warehousewoman', 'Warehousewoman'),
    ('watchmaker', 'Watchmaker'),
    ('weaver', 'Weaver'),
    ('weighbridge clerk', 'Weighbridge Clerk'),
    ('weighbridge operator', 'Weighbridge Operator'),
    ('welder', 'Welder'),
    ('welfare assistant', 'Welfare Assistant'),
    ('welfare officer', 'Welfare Officer'),
    ('welfare rights officer', 'Welfare Rights Officer'),
    ('wheel clamper', 'Wheel Clamper'),
    ('wholesale newspaper', 'Wholesale Newspaper'),
